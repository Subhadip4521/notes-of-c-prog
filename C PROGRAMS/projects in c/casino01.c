...
int main(){
    ...
    age(a);
    printf("\n\n**************************");
    printf("\nIf the number generated by the system will be odd, you will win:)\nIf the number generated by the system will be even, you will lose:( \n");
...
void num(){
    ...
    printf("%d\n",number);
        if(number%2==0){
            printf("\nAn even number has been generated!\n");
            printf("Ah! You LOST!!! :(\n");
            printf("Better luck next time\n");
        }
        if(number%2!=0){
            printf("\nAn odd number has been generated!\n");
